...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1237760505ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="185">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotel_manage&table=users">`hotel_manage`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotel_manage&table=room">`hotel_manage`.`room`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hotel_manage&table=booking">`hotel_manage`.`booking`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=car_rental&table=book">`car_rental`.`book`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=car_rental&table=car">`car_rental`.`car`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=car_rental&table=user">`car_rental`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_hotel&table=admin">`db_hotel`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=car_rental&table=payment">`car_rental`.`payment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_hotel&table=tbl_email_config">`db_hotel`.`tbl_email_config`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=trms&table=admin">`trms`.`admin`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7b4b452c68337e405b23687351736a6f">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="185"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="hotel_manage" targettable="users">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="hotel_manage" targettable="booking">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `booking` DROP `user_name`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="hotel_manage" targettable="booking">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `booking`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="hotel_manage" targettable="room">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `room`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="hotel_manage" targettable="room">
                            <div class="action_content">
